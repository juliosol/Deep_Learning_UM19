    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                # compute loss using the criterion function                                        #
                ####################################################################################
...
def freeze(device, dataloaders, dataset_sizes, class_names):
    ...
    #                             START OF YOUR CODE                                   #
    ####################################################################################
    # Freeze all parameters in the pre-trained network.                               #
...
def main():
    ...
    data_dir = 'D:/Julio/Documents/Michigan_v2/CS/EECS_598_Deep_Learning/HW/Homework2/code/hymenoptera_data'
